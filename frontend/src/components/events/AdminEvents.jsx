...
const Events = () => {
  ...
  async function deleteEvent(id) {
    ...
    const filtered = events.filter((event) => id !== event._id);
  ...
  return (
    <div className="w-full pt-4 overflow-auto">
      ...
      {events.length === 0 ? (
        <div className="w-full text-3xl text-bluePurple h-full flex items-center justify-center">
          No Item
        </div>
      ) : (
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            ...
                            if (eventStatus != "Scheduled") {
                              await adminAction.updateEventStatus(
                                eventId,
                                eventStatus
                              );
                            }
